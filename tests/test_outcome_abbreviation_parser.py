...
from basketball_reference_web_scraper.data import Outcome, OutcomeAbbreviationsToOutcome
...
class TestOutcomeAbbreviationParser(TestCase):
    def setUp(self):
        self.parser = OutcomeAbbreviationParser(abbreviations_to_outcomes=OutcomeAbbreviationsToOutcome)
