...
class TestPlayersAdvancedSeasonTotals(TestCase):
    ...
    def test_2019_jimmy_butler_combined_season_totals(self):
        ...
        self.assertEqual(philly_jimmy_butler["offensive_box_plus_minus"], 2.6)
        self.assertEqual(philly_jimmy_butler["defensive_box_plus_minus"], 0.6)
        self.assertEqual(philly_jimmy_butler["box_plus_minus"], 3.2)
        self.assertEqual(philly_jimmy_butler["value_over_replacement_player"], 2.9)
