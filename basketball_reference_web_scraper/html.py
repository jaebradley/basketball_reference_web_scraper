...
class ShootingDietTable:
    ...
    def rows(self):
        shot_diet_rows = []
        for row_html in self.html.xpath(self.rows_query):
            row = ShootingDietRow(html=row_html)
            # Basketball Reference includes a "total" row for players that got traded
            # which is essentially a sum of all player team rows
            # I want to avoid including those, so I check the "team" field value for "TOT"
            if not row.is_combined_totals:
                shot_diet_rows.append(row)
        return shot_diet_rows
...
class ShootingDietRow:
    ...
    @property
    def two_point_take_percentage(self):
    ...
    @property
    def zero_to_three_meters_take_percentage(self):
    ...
    @property
    def three_to_ten_meters_take_percentage(self):
    ...
    @property
    def ten_to_sixteen_meters_take_percentage(self):
    ...
    @property
    def sixteen_to_rest_meters_take_percentage(self):
    ...
    @property
    def three_point_take_percentage(self):
    ...
    @property
    def zero_to_three_meters_percentage(self):
    ...
    @property
    def three_to_ten_meters_percentage(self):
    ...
    @property
    def ten_to_sixteen_meters_percentage(self):
    ...
    @property
    def sixteen_to_rest_meters_percentage(self):
    ...
    @property
    def assisted_two_point_percentage(self):
    ...
    @property
    def assisted_three_point_percentage(self):
    ...
    @property
    def corner_three_take_percentage(self):
    ...
    @property
    def corner_three_percentage(self):
