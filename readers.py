...
from basketball_reference_web_scraper.helper_functions.schedule.parsed_events_in_range_returner import ParsedEventsInRangeReturner
...
def return_scheduled_games_in_range_inclusive(utc_start_datetime, utc_end_datetime):
    return ParsedEventsInRangeReturner.return_scheduled_events_in_range_inclusive(utc_start_datetime=utc_start_datetime, utc_end_datetime=utc_end_datetime)


def return_json_encoded_scheduled_games_in_range_inclusive(utc_start_datetime, utc_end_datetime):
    return ParsedEventsInRangeReturner.return_json_encoded_scheduled_events_in_range_inclusive(utc_start_datetime=utc_start_datetime, utc_end_datetime=utc_end_datetime)